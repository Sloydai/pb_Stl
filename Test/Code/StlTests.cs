...
namespace Parabox.Stl.Test
{
    ...
    sealed class StlTests
    {
        ...
        {
            DoVerifyWriteString(k_TestModelsDir + "Cylinder_ASCII_RH.stl",
                GameObject.CreatePrimitive(PrimitiveType.Cylinder));
            DoVerifyWriteString(k_TestModelsDir + "Sphere_ASCII_RH.stl",
        ...
        public void VerifyWriteBinary()
        {
            ...
            DoVerifyWriteBinary(k_TestModelsDir + "Cylinder_BINARY_RH.stl",
                GameObject.CreatePrimitive(PrimitiveType.Cylinder));
            DoVerifyWriteBinary(k_TestModelsDir + "Sphere_BINARY_RH.stl",
                GameObject.CreatePrimitive(PrimitiveType.Sphere));
        ...
        private void DoVerifyWriteBinary(string expected_path, GameObject go)
        {
            ...
            Assert.IsTrue(
                Exporter.WriteFile(temp_model_path, go.GetComponent<MeshFilter>().sharedMesh, FileType.Binary));
