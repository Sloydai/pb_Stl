...
namespace Parabox.Stl
{
    public static class Exporter
    {
        ...
        /// <param name="convertToRightHandedCoordinates"></param>
        /// <returns></returns>
        public static bool WriteFile(string path, Mesh mesh, FileType type = FileType.Ascii,
         ...
         */
        public static bool WriteFile(string path, IList<Mesh> meshes, FileType type = FileType.Ascii,
            bool convertToRightHandedCoordinates = true)
        {
            try
            {
                switch (type)
                {
                    case FileType.Binary:
                    {
                        using (BinaryWriter writer =
                               new BinaryWriter(File.Open(path, FileMode.Create), new ASCIIEncoding()))
                        {
